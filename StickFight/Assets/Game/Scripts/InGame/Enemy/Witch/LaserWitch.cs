...
public class LaserWitch : MonoBehaviour
{
 [SerializeField] private LineRenderer line;
    ...
    private void Update()
    {
        if (OnLaser)
        {
            Vector2 lastPoint = transform.position + (Vector3)direction * distance;
            ...
            if (hit)
            {
                ...
                if (player!=null) {
                    ...
                    lastPoint = transform.position + (Vector3)direction * distance;
                }
            }
